...
//                "Server\\Server41", "Server\\Server43", "Server\\Server46", "Server\\Server47", "Server\\Server48",
        ...
        String[] floatValueDatasets = new String[]{
                "Server\\Server35", "Server\\Server43", "Server\\Server47", "Server\\Server48",
                "Server\\Server62", "Server\\Server77", "Server\\Server82", "Server\\Server97",
                "Server\\Server106", "Server\\Server115"
        };
